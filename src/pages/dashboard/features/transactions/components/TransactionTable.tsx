    ...
    .filter((transaction) => {
      ...
      return (
        (transaction.description
          ...
          : false) || transaction.amount.toString().includes(searchTerm)
      );
    })
    .sort((a, b) => {
      switch (sortOption) {
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <InputLabel>
                {t("dashboard.transactions.filters.sort.label")}
              </InputLabel>
              <Select
                size="small"
              ...
              >
                <MenuItem value="date_desc">
                  {t("dashboard.transactions.filters.sort.dateDesc")}
                </MenuItem>
                <MenuItem value="date_asc">
                  {t("dashboard.transactions.filters.sort.dateAsc")}
                </MenuItem>
                <MenuItem value="amount_desc">
                  {t("dashboard.transactions.filters.sort.amountDesc")}
                </MenuItem>
                <MenuItem value="amount_asc">
                  {t("dashboard.transactions.filters.sort.amountAsc")}
                </MenuItem>
              </Select>
            </FormControl>
          ...
          {loading ? (
            ...
            >
              <Typography variant="h5" color="text.secondary">
                🔍 {t("dashboard.transactions.table.noTransactionsFound")} "
                {searchTerm}" 🔍
              </Typography>
            </Box>
          ) : (
                  ...
                  >
                    ...
                    >
                      <Typography variant="body1" fontWeight={500}>
                        {transaction.description ||
                          t("dashboard.transactions.table.noDescription")}
                      </Typography>
